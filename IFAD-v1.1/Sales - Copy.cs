...
namespace IFAD_v1._1
{
    public partial class Sales : Form
    {
        ...
        public void DataGrid()
        {
            ...
            cmd.CommandText = "SELECT TempSalesProductID as 'Product CODE', Product.Name as 'Name', TempSalesQuantity as 'Quantity', TempSalesSalePrice as 'Price', TempSalesTotal as 'Total', TempSalesDate as 'Date' FROM TempSales, Product WHERE TempSales.TempSalesCompanyID='"+ CompanyID + "' AND TempSales.TempSalesProductID=Product.ID";
            cmd.ExecuteNonQuery();
        ...
        private void AddSalesDetails()
        {
            ...
            con.Open();
            sql = @"UPDATE Sales SET SalesRemarks ='" + textBoxRemarks.Text + "', IsChequeReceive = '"+ IsChequeReceive + "'  WHERE SalesNo='" + SerialNo + "'";
        ...
        private void AddReceivedChangeInTempSales()
        {
            SqlConnection con1 = new SqlConnection(conStr);
            con1.Open();
            string sql1 = @"UPDATE TempSales SET TempSalesReceivedAmount ='"+textBoxReceiveAmount.Text+"',TempSalesChangeAmount = '"+ textBoxReturnAmount.Text+ "',TempSalesVatRate='"+ textBoxVAT.Text+ "',TempSalesVatTotal = '"+ textBoxTotalWithVat.Text+ "', TempSalesRemarks = '"+ textBoxRemarks .Text + "' WHERE TempSalesCompanyID = '"+CompanyID+"'";
            SqlCommand cmd1 = new SqlCommand(sql1, con1);
            cmd1.ExecuteNonQuery();
            con1.Close();
        }
