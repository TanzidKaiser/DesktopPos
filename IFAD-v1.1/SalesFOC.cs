...
{
    public partial class SalesFOC : Form
    {
        public SalesFOC()
        {
            InitializeComponent();
            ...
            else
            {
               ...
               InsertSales();
                ...
                if (checkBoxSalesWithoutPrint.Checked == false)
                {
                 ...
                 MessageBox.Show("FOC Sales Successfully....!!!!");
                buttonReports.Enabled = false;
