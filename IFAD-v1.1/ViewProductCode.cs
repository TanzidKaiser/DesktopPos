...
{
    public partial class ViewProductCode : Form
    {
        ...
        private void ViewProductCode_Load(object sender, EventArgs e)
        {

            TableLogOnInfos crtableLogoninfos = new TableLogOnInfos();
            TableLogOnInfo crtableLogoninfo = new TableLogOnInfo();
            ConnectionInfo crConnectionInfo = new ConnectionInfo();
            string rPath = ReportPaths+"CrystalReportAllProduct.rpt";
            cryRpt.Load(rPath);
        ...
        private void ViewProductCode_FormClosed(object sender, FormClosedEventArgs e)
        {
            cryRpt.Close();
            cryRpt.Dispose();
