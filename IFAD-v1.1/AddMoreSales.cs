...
{
    public partial class AddMoreSales : Form
    {
        public AddMoreSales()
        {
            InitializeComponent();
        ...
        public string SalesInvoiceNo = SalesEdit.InvoiceNoForEdit;
        ...
        private void Load_Form()
        {
            int i = 1;
            SqlConnection conn = new SqlConnection(conStr);
            string query1 = "SELECT * FROM Sales WHERE SalesNo='"+ SalesInvoiceNo + "'";
            SqlCommand command1 = new SqlCommand(query1, conn);
            conn.Open();
            SqlDataReader reader1 = command1.ExecuteReader();
            while (reader1.Read() && i==1)
            {
                textBoxDate.Text = reader1["SalesDate"].ToString();
                textBoxCustomerName.Text = reader1["SalesCustomerName"].ToString();

                textBoxPurchaseBy.Text = reader1["SalesPuechaseBy"].ToString();
                textBoxPruchaseByContact.Text = reader1["SalesPurchaseByContact"].ToString();
                textBoxRemarks.Text = reader1["SalesRemarks"].ToString();
                textBoxReference.Text = reader1["Reference"].ToString();
                CustomerID = Convert.ToInt32(reader1["SalesCustomerID"]);
                textBoxDiscountTaka.Text= reader1["SalesProductDiscount"].ToString();
            ...
            textBoxInvoiceNo.Text = SalesInvoiceNo;
        ...
        public void TempSales(string temp_product_code,string name, double qantity, double temp_sale_price, double temp_purchase_price, string invoice_no, double discount, double price_total, int temp_pro_id)
        {
            ...
            SqlConnection connection = new SqlConnection(conStr);
            string query = "INSERT INTO TempSales(TempSalesCompanyID,TempSalesNo,TempSalesDate,TempSaleTime,TempSalesCustomerID,TempSalesRemarks,TempSalesProductID,TempSalesPurchasePrice,TempSalesSalePrice,TempSalesQuantity,TempSalesProductDiscount,TempSalesTotal,TempSalesCustomerName,TempSalesSoldBy, TempSalesPuechaseBy, TempSalesPurchaseByContact) VALUES(1,'" + invoice_no + "','" + date + "','" + textBoxTime.Text + "','" + sales_cust_id + "','" + textBoxRemarks.Text + "','" + textBoxPdoductCode.Text + "','" + temp_purchase_price + "','" + temp_sale_price + "','" + qantity + "','" + discount + "','" + price_total + "','" + textBoxCustomerName.Text + "','"+ currentuser + "', '"+ textBoxPurchaseBy.Text + "', '" + textBoxPruchaseByContact.Text + "')";
            SqlCommand command = new SqlCommand(query, connection);
            connection.Open();
        ...
        private void SeeTotal_Component()
        {
            ...
            SqlConnection connection = new SqlConnection(conStr);
            string query = "SELECT * FROM Sales WHERE SalesNo='"+ SalesInvoiceNo + "'";
            SqlCommand command = new SqlCommand(query, connection);
            connection.Open();
            SqlDataReader reader = command.ExecuteReader();
            ...
            while (reader.Read())
            {
                total_product = total_product + Convert.ToDouble(reader["SalesQuantity"]);
                total = total + Convert.ToDouble(reader["SalesTotal"]);
                total_dis = total_dis + Convert.ToDouble(reader["SalesProductDiscount"]);
                total_item++;
            }
            reader.Close();
            connection.Close();
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                textBoxProductName.Text = textBoxPdoductCode.Text = textBoxPrice.Text = textBoxUnitType.Text = textBoxProCode.Text = "";
        ...
        private void AddSalesDetails()
        {
            ...
            con.Open();
            sql = @"UPDATE Sales SET SalesRemarks ='" + textBoxRemarks.Text + "', Reference = '" + textBoxReference.Text + "',SalesProductDiscount= '" + textBoxDisTotal.Text + "', SalesCustomerName= '" + textBoxCustomerName.Text + "', SalesSoldBy= '" + currentuser + "', SalesReceivedAmount= '" + textBoxReceiveAmount.Text + "',SalesChangeAmount= '" + textBoxReturnAmount.Text + "',SalesVatTotal='" + textBoxTotalWithVat.Text + "',SalesPuechaseBy='" + textBoxPurchaseBy.Text + "', SalesPurchaseByContact='" + textBoxPruchaseByContact.Text + "' WHERE SalesNo='" + SalesInvoiceNo + "'";
        ...
        private void AddReceivedChangeInTempSales()
        {
            SqlConnection con1 = new SqlConnection(conStr);
            con1.Open();
            string sql1 = @"UPDATE TempSales SET TempSalesReceivedAmount ='"+textBoxReceiveAmount.Text+"',TempSalesChangeAmount = '"+ textBoxReturnAmount.Text+ "',TempSalesVatRate='"+ textBoxVAT.Text+ "',TempSalesVatTotal = '"+ textBoxTotalWithVat.Text+ "', TempSalesRemarks = '"+ textBoxRemarks .Text + "'";
            SqlCommand cmd1 = new SqlCommand(sql1, con1);
            cmd1.ExecuteNonQuery();
            con1.Close();
        }
        ...
        private void UpdateTempSalesDiscount(int countsales)
        {
            ...
            SerialNo = SalesInvoiceNo;
            string Custname = textBoxCustomerName.Text;
            int id = GetCustId(Custname);
            SqlConnection con1 = new SqlConnection(conStr);
            con1.Open();
            string sql1 = @"UPDATE TempSales SET TempSalesProductDiscount ='" + textBoxDisTotal.Text + "', TempSalesReference='" + textBoxReference.Text + "',TempSalesCustomerID='" + id+ "',TempSalesNo='" + SerialNo + "'";
            SqlCommand cmd1 = new SqlCommand(sql1, con1);
            cmd1.ExecuteNonQuery();
            con1.Close();
        }
        ...
        private void buttonReports_Click(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               InsertSales();
                ...
                Insert_Customer_Ledger(CustomerID);
                ...
                if (checkBoxSalesWithoutPrint.Checked == false)
                {
                 ...
                 SerialNo = "";
                 Temp_Sales_Truncate();
                 textBoxRemarks.Text = textBoxPurchaseBy.Text = textBoxPruchaseByContact.Text = textBoxCustomerName.Text = textBoxGroupName.Text = textBoxCompanyAddress.Text = textBoxVatRegNo.Text = textBoxReference.Text = textBoxPdoductCode.Text = textBoxProCode.Text = string.Empty;
        ...
        private void Insert_Customer_Ledger(int id)
        {
            ...
            string conStr = ConfigurationManager.ConnectionStrings["PosConString"].ToString();
            SqlConnection connection = new SqlConnection(conStr);
            string query11 = "UPDATE CustomerLedger SET ReceiveDate = '" + date + "' ,CustomerID = '" + id + "',Debit = '" + ledger_debit + "',Credit = '" + ledger_credit + "',Remarks = '" + ledger_remarks + "',NextPaymentDate = '" + dateTimePicker1.Text + "',IsPreviousDue = '" + zero + "' WHERE InvoiceNo='" + ledger_invoice_no + "'";
        ...
        private void textBoxReceiveAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                textBoxReceiveAmount.Text = "0";
                if (Convert.ToInt32(textBoxReceiveAmount.Text) >= Convert.ToInt32(textBoxTotalWithVat.Text))
                {
                    textBoxReturnAmount.Text = (Convert.ToInt32(textBoxReceiveAmount.Text) - Convert.ToInt32(textBoxTotalWithVat.Text)).ToString();
                    textBoxDueAmount.Text = "0";
                }
                if (Convert.ToInt32(textBoxReceiveAmount.Text) < Convert.ToInt32(textBoxTotalWithVat.Text))
                {
                    textBoxDueAmount.Text = (Convert.ToInt32(textBoxTotalWithVat.Text) - Convert.ToInt32(textBoxReceiveAmount.Text)).ToString();
                    textBoxReturnAmount.Text = (Convert.ToInt32(textBoxReceiveAmount.Text) - Convert.ToInt32(textBoxTotalWithVat.Text)).ToString();
                }
